                    ...
                    <div class="card-body">
                        <div class="row">
                            <div style="font-size: 16px;" class="col-md-10 offset-md-1">
                                ...
                                <p>These terms of use are entered into by and between You and {{ $app_name }} ("we" or
                                    "us"). The following terms and conditions and all documents incorporated by reference
                                    (collectively, "Terms of Use"), govern your access to and use of <a target="_blank"
                                        href="{{ $app_url }}">{{ $app_url }}</a>, including any content,
                                    functionality and services offered on or through <a target="_blank"
                                        href="{{ $app_url }}">{{ $app_url }}</a> (the "Website").</p>

                                <p>Please read the Terms of Use carefully before you start to use the Website. By using the
                                    Website, you accept and agree to be bound and abide by these Terms of Use and our
                                    Privacy Policy, found at <a target="_blank"
                                        href="{{ route('privacy_policy') }}">{{ route('privacy_policy') }}</a>, incorporated
                                    herein by reference. If you do not want to agree to these Terms of Use or the Privacy
                                    Policy, you must not access or use the Website.</p>

                                <h4 class="font-weight-semibold">Changes To The Terms Of Use</h4>

                                <p>We may revise and update these Terms of Use from time to time in our sole discretion. All
                                    changes are effective immediately when we post them. However, any changes to the dispute
                                    resolution provisions set forth in Governing Law and Jurisdiction will not apply to any
                                    disputes for which the parties have actual notice prior to the date the change is posted
                                    on the Website.</p>

                                <p>Your continued use of the Website following the posting of revised Terms of Use means
                                    that you accept and agree to the changes. You are expected to check this page from time
                                ...
                                <ul>
                                    ...
                                    <li>Ensuring that all persons who access the Website through your internet connection
                                        are aware of these Terms of Use and comply with them.</li>
                                </ul>
                                ...
                                <p>We have the right to disable any user name, password, or other identifier, whether chosen
                                    ...
                                    including if, in our opinion, you have violated any provision of these Terms of Use.</p>
                                ...
                                <p>These Terms of Use permit you to use the Website for your personal, non-commercial use
                                    ...
                                    on our Website in violation of any laws.</p>
                                ...
                                <p>The {{ $app_name }} name and all related names, logos, slogans, mottos, and designs
                                    are trademarks of ours or our affiliates or licensors. You must not use such marks
                                    without our prior written permission. All other names, logos, product and service names,
                                    designs and slogans on this Website are the trademarks of their respective owners.</p>

                                <h4 class="font-weight-semibold">Prohibited Uses</h4>

                                <ul>
                                    <li>You may use the Website only for lawful purposes and in accordance with these Terms
                                        of Use. You agree not to use the Website:</li>
                                    <li>In any way that violates any applicable federal, state, local, or international law
                                    ...
                                    <li>To send, knowingly receive, upload, download, use or re-use any material which does
                                        not comply with the Content Standards set out in these Terms of Use.</li>
                                    ...
                                    <li>To impersonate or attempt to impersonate us, one of our employees, another user or
                                        any other person or entity (including, without limitation, by using e-mail addresses
                                    ...
                                    <li>To engage in any other conduct that restricts or inhibits anyone's use or enjoyment
                                        of the Website, or which, as determined by us, may harm us or users of the Website
                                        or expose them to liability.</li>
                                </ul>

                                <h4 class="font-weight-semibold">Additionally, You Agree Not To:</h4>
                                <ul>
                                    <li>Use the Website in any manner that could disable, overburden, damage, or impair the
                                        site or interfere with any other party's use of the Website, including their ability
                                        to engage in real time activities through the Website.</li>
                                    <li>Use any robot, spider or other automatic device, process or means to access the
                                        ...
                                        Website.</li>
                                    <li>Use any manual process to monitor or copy any of the material on the Website or for
                                    ...
                                    <li>Attempt to gain unauthorized access to, interfere with, damage or disrupt any parts
                                        of the Website, the server on which the Website is stored, or any server, computer
                                        or database connected to the Website.</li>
                                    <li>Attack the Website via a denial-of-service attack or a distributed denial-of-service
                                        attack.</li>
                                    <li>Use the Website in any manner that violates any applicable {{ $app_name }}
                                        policy, rule, or procedure.</li>
                                    <li>Use the Website in any manner that contravenes Catholic Mercy tradition, faith, and
                                        morals or the legacy of Catholic Mercy education.</li>
                                ...
                                <p>The Website may contain message boards, chat rooms, personal web pages or profiles,
                                    ...
                                    or other persons (hereinafter, "post") content or materials (collectively, "User
                                ...
                                <p>Any User Contribution you post to the site will be considered non-confidential and
                                    ...
                                    distribute and otherwise disclose to third parties any such material.</p>

                                <p>You represent and warrant that:</p>

                                <ul>
                                    <li>You own or control all rights in and to the User Contributions and have the right to
                                        grant the license granted above to us and our licensees, successors and assigns.
                                    </li>
                                ...
                                <p>You understand and acknowledge that you are responsible for any User Contributions you
                                    submit or contribute, and you, not us, have full responsibility for such content,
                                ...
                                <ul>
                                    ...
                                    <li>Take any action with respect to any User Contribution that we deem necessary or
                                        ...
                                        Contribution violates the Terms of Use, including the Content Standards, infringes
                                        any intellectual property right or other right of any person or entity, threatens
                                        the personal safety of users of the Website or the public or could create liability
                                        for us.</li>
                                    <li>Disclose your identity or other information about you to any third party who claims
                                        that material posted by you violates their rights, including their intellectual
                                        property rights or their right to privacy.</li>
                                    <li>Take appropriate legal action, including without limitation, referral to law
                                        enforcement, for any illegal or unauthorized use of the Website.</li>
                                    <li> Terminate or suspend your access to all or part of the Website for any or no
                                        reason, including without limitation, any violation of these Terms of Use.</li>
                                </ul>
                                ...
                                <p> Without limiting the foregoing, we have the right to fully cooperate with any law
                                    ...
                                    identity or other information of anyone posting any materials on or through the Website.
                                </p>

                                <p>YOU WAIVE AND HOLD HARMLESS {{ strtoupper($app_name) }} FROM ANY CLAIMS RESULTING FROM
                                    ANY ACTION TAKEN BY {{ strtoupper($app_name) }} DURING OR AS A RESULT OF ITS
                                    INVESTIGATIONS AND FROM ANY ACTIONS TAKEN AS A CONSEQUENCE OF INVESTIGATIONS BY
                                    {{ strtoupper($app_name) }} OR LAW ENFORCEMENT AUTHORITIES.</p>

                                <p>However, we do not undertake to review all material before it is posted on the Website,
                                ...
                                <p>These content standards apply to any and all User Contributions and use of Interactive
                                    ...
                                    state, local and international laws and regulations. Without limiting the foregoing,
                                    User Contributions must not:</p>
                                ...
                                <ul>
                                    ...
                                    <li>Violate the legal rights (including the rights of publicity and privacy) of others
                                        ...
                                        Terms of Use and our <a target="_blank"
                                            href="{{ route('privacy_policy') }}">Privacy Policy</a>.</li>
                                    <li>Be likely to deceive any person.</li>
                                    <li>Promote any illegal activity, or advocate, promote or assist any unlawful act.</li>
                                    <li>Cause annoyance, inconvenience or needless anxiety or be likely to upset, embarrass,
                                    ...
                                    <li>Give the impression that they emanate from or are endorsed by us or any other person
                                ...
                                <p>The information presented on or through the Website is made available solely for general
                                    ...
                                    materials by you or any other visitor to the Website, or by anyone who may be informed
                                ...
                                <p>This Website may include content provided by third parties, including materials provided
                                    ...
                                    those materials. These materials do not necessarily reflect the opinion of us. We are
                                ...
                                <p>All information we collect on this Website is subject to our Privacy Policy. By using the
                                    Website, you consent to all actions taken by us with respect to your information in
                                    compliance with the <a target="_blank" href="{{ route('privacy_policy') }}">Privacy
                                        Policy</a>.</p>
                                ...
                                <p>vYou may link to our homepage, provided you do so in a way that is fair and legal and
                                ...
                                <p>You agree to cooperate with us in removing any link we ask you to. We reserve the right
                                ...
                                <p>You understand that we cannot and do not guarantee or warrant that files available for
                                    ...
                                    accuracy of data input and output, and for maintaining a means external to our site for
                                    any reconstruction of any lost data. WE WILL NOT BE LIABLE FOR ANY LOSS OR DAMAGE CAUSED
                                ...
                                <p>YOUR USE OF THE WEBSITE, ITS CONTENT AND ANY SERVICES OR ITEMS OBTAINED THROUGH THE
                                    ...
                                    WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED. NEITHER {{ strtoupper($app_name) }}
                                    NOR ANY PERSON ASSOCIATED WITH {{ strtoupper($app_name) }} MAKES ANY WARRANTY OR
                                    ...
                                    {{ strtoupper($app_name) }} NOR ANYONE ASSOCIATED WITH {{ strtoupper($app_name) }}
                                    ...
                                    DEFECTS WILL BE CORRECTED, THAT OUR SITE OR THE SERVER THAT MAKES IT AVAILABLE ARE FREE
                                    OF VIRUSES OR OTHER HARMFUL COMPONENTS OR THAT THE WEBSITE OR ANY SERVICES OR ITEMS
                                    OBTAINED THROUGH THE WEBSITE WILL OTHERWISE MEET YOUR NEEDS OR EXPECTATIONS.</p>

                                <p>{{ strtoupper($app_name) }} HEREBY DISCLAIMS ALL WARRANTIES OF ANY KIND, WHETHER EXPRESS
                                    OR IMPLIED, STATUTORY OR OTHERWISE, INCLUDING BUT NOT LIMITED TO ANY WARRANTIES OF
                                    NON-INFRINGEMENT.</p>
                                ...
                                <p>IN NO EVENT WILL {{ strtoupper($app_name) }}, ITS AFFILIATES OR THEIR LICENSORS, SERVICE
                                    ...
                                    USE, THE WEBSITE, ANY WEBSITES LINKED TO IT, ANY CONTENT ON THE WEBSITE OR SUCH OTHER
                                    WEBSITES OR ANY SERVICES OR ITEMS OBTAINED THROUGH THE WEBSITE OR SUCH OTHER WEBSITES,
                                    INCLUDING ANY DIRECT, INDIRECT, SPECIAL, INCIDENTAL, CONSEQUENTIAL OR PUNITIVE DAMAGES,
                                    INCLUDING BUT NOT LIMITED TO, PERSONAL INJURY, PAIN AND SUFFERING, EMOTIONAL DISTRESS,
                                    LOSS OF REVENUE, LOSS OF PROFITS, LOSS OF BUSINESS OR ANTICIPATED SAVINGS, LOSS OF USE,
                                    LOSS OF GOODWILL, LOSS OF DATA, AND WHETHER CAUSED BY TORT (INCLUDING NEGLIGENCE),
                                ...
                                <p>You agree to defend, indemnify and hold harmless {{ $app_name }}, its affiliates,
                                    ...
                                    of these Terms of Use or your use of the Website, including, but not limited to, your
                                    User Contributions, any use of the Website's content, services and products other than
                                    as expressly authorized in these Terms of Use or your use of any information obtained
                                    from the Website.</p>
                                ...
                                <p>All matters relating to the Website and these Terms of Use and any dispute or claim
                                    ...
                                    or claims), shall be governed by and construed in accordance with the laws of Nigeria
                                    without giving effect to any choice or conflict of law provision or rule.</p>

                                <p>Any legal suit, action or proceeding arising out of, or related to, these Terms of Use or
                                    the Website shall be instituted exclusively in the federal courts of Nigeria, although
                                    we retain the right to bring any suit, action or proceeding against you for breach of
                                    these Terms of Use in your country of residence or any other relevant country. You waive
                                ...
                                <p>At {{ $app_name }}’s sole discretion, it may require You to submit any disputes
                                    arising from the use of these Terms of Use or the Website, including disputes arising
                                    from or concerning their interpretation, violation, invalidity, non-performance, or
                                    termination, to final and binding arbitration under the Arbitration and Concilliation
                                    Act of Nigeria</p>

                                <h4 class="font-weight-semibold">Limitation on Time to File Claims</h4>

                                <p>ANY CAUSE OF ACTION OR CLAIM YOU MAY HAVE ARISING OUT OF OR RELATING TO THESE TERMS OF
                                ...
                                <p>No waiver of by {{ $app_name }} of any term or condition set forth in these Terms of
                                    Use shall be deemed a further or continuing waiver of such term or condition or a waiver
                                    of any other term or condition, and any failure of {{ $app_name }} to assert a
                                    right or provision under these Terms of Use shall not constitute a waiver of such right
                                    or provision.</p>
                                ...
                                <p>If any provision of these Terms of Use is held by a court or other tribunal of competent
                                    ...
                                    of the Terms of Use will continue in full force and effect.</p>

                                <h4 class="font-weight-semibold">Entire Agreement</h4>

                                <p>These Terms of Use and our <a target="_blank"
                                        href="{{ route('privacy_policy') }}">Privacy Policy</a> constitute the sole and
                                    entire agreement between you and {{ $app_name }} with respect to the Website and
                                ...
                                <p>If you do have any comments or concerns regarding but not limited to these Terms of Use.
                                    Please contact us.</p>

                                <p>This website is operated by {{ $app_name }}.</p>

                                <p>All other feedback, comments, requests for technical support and other communications
                                    relating to the Website should be directed to the School Administrator. Please call
                                    {{ $contact_phone }}</p>
                            </div>
                        </div>
                    </div>
